...
/// Modify a specific section of a note.
///
/// ```
/// obs note patch <path> [--heading <text>] [--block <id>] [--frontmatter]
///     [--insert-position beginning|end] [--content <text>] [--json]
/// ```
class NotePatchCommand extends Command<int> {
  NotePatchCommand() {
    argParser
      ..addFlag(
        'json',
  ...
  @override
  String get description => 'Modify a section of a note.';

  @override
  String get invocation => 'obs note patch <path>';
  ...
  Future<int> run() async {
    ...
    if (args.isEmpty) {
      stderr.writeln('Usage: obs note patch <path>');
      return 64;
    }
    ...
    try {
      ...
      if (useJson) {
        ...
        // ignore: avoid_print
        print(green('Patched: $path$targetStr'));
      }
      return 0;
    } catch (e) {
